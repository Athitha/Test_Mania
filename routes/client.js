...
router.post('/Devices', function(req, res) {
    ...
    {
        livevalue = {cre_name : req.body.cre_name, cre_url : req.body.cre_url, cre_dead : req.body.cre_dead, cre_award : req.body.cre_award, cre_expec : req.body.cre_expec, cre_devices: ['11','12'], inputs : JSON.stringify([]) };
        res.render('ClientPhase/CreateProject/Devices',livevalue);
    } 
});
